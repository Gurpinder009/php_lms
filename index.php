...
try {
    ...
    $routes = [
        ...
        "/search-books\?[=a-zA-Z0-9\[\]_ %]*" => "logic/book_search.php",
        "/search\?[title=a-zA-Z0-9\[\]_ %]+" => "logic/book_search1.php",
        "/logout" => "logic/logout.php",
        "/404[\/\?a-zA-Z0-9\[\]&=_\- %+]*" => "views/pages/_404.php",
        "/books[?=a-zA-Z0-9\[\]_ %]*" => "views/pages/all/books.php",
        "/subscriber/books[?=a-zA-Z0-9\[\]_ %]*" => "views/pages/all/subscriber_books.php",
        ...
        "/edit/forget-password[?=a-zA-Z0-9\[\]_ %]*" => "views/pages/password/forget_password.php",
        ...
        "/subscriber/create[?=a-zA-Z0-9\[\]_ %]*" => "views/pages/create/subscriber_create.php",
        "/staff/create[?=a-zA-Z0-9\[\]_ %]*" => "views/pages/create/staff_member_create.php",
        ...
        "/staff/email_verfication" => "logic/verification/register_staff_verification.php",
        "/subscriber/email_verfication" => "logic/verification/register_user_verification.php",
        ...
        "/update/password" => "logic/update/update_password.php",
    ...
    LogHandler::errorLog("Application crashed", ["error" => $ex->getMessage(), "code" => $ex->getCode()]);
}
