...
?>
    ...
    <div class="pager">
                <a class ="btn  <?php if (($offset / 10 + 1) < 2) {
    echo "disabled";
}
?>" href="/subscriber/books?offset=<?php echo $offset - 10 ?>"><i class="fa-solid fa-angles-left"></i> Prev</a>
                <span class="page"><?php $data = (integer) ($offset / 10) + 1;
echo $data;?></span>
                <a class="btn <?php if (($count <= $offset + 10)) {
    echo "disabled";
}
?>" href="/subscriber/books?offset=<?php echo $offset + 10 ?>">Next <i class="fa-solid fa-angles-right"></i></a>
            </div>
</div>
