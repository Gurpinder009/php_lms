...
<div class="form-container">
  ...
  >
    ...
    <div class="form-field">
      ...
      />
      <span id="show-password-toggler" onmousedown="toggle_password_visibility('password')"
      onmouseup="toggle_password_visibility('password')"><svg
    ...
    <div class="signup-link">
      <span>Login As Staff Instead? </span><a href="/sign-up">Staff Login</a>
    </div>
  </form>
</div>
