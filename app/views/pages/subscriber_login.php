...
<div class="form-container">
  <form
    ...
    autocomplete="off"
    method="POST"
    action="/subscriber/auth"
    autocomplete="off"
    onsubmit="return validateULForm(this)"
  >
    <div class="form-text">
      <h1 class="form-heading">Subscriber Login</h1>
    </div>
    ...
    <div class="form-field">
      ...
      />
      <span id="show-password-toggler" onclick="toggle_password_visibility('password')"><svg
    ...
    <div class="signup-link">
      <span>Login As Staff Instead? </span><a href="/login">Staff Login</a>
    </div>
  </form>
</div>
