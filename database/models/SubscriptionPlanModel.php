...
class SubscriptionPlanModel
{
    ...
    public static function insert($data)
    {
        ...
        try {
            $stmt = DatabaseConnection::getInstance()
                ->prepare("insert into subscription_plans (title,isActive,price,book_issue_limit,issue_days,time_period) values
    ...
    public static function getSubscribedPlanInfo(int $id)
    {
        try {
            $result = DatabaseConnection::getInstance()
